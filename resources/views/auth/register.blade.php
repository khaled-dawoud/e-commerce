...
<head>
    ...
    <style>
        * {
        ...
        .welcome-container {
            /* background: #eeeeee75; */
            background: url({{ asset('login2.avif') }});
    ...
    <div class="container">
        <main class="signup-container">
            ...
            <form class="signup-form" method="POST" action="{{ route('register') }}">
                ...
                <label class="inp">
                    <input id="name" type="text" class="input-text @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus>
